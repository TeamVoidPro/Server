...
public class ParkingPlaceOwner
{
    ...
    [Required(ErrorMessage = "Land Address number is required")]
    [RegularExpression(@"^[a-zA-Z0-9\s]+$", ErrorMessage = "Number should contain only alphanumeric characters.")]
    [StringLength(50, MinimumLength = 2, ErrorMessage = "Invalid Number.")]
    ...
    public OnSiteVerifications OnSiteVerifications { get; set; } = null!;

    public VerificationSchedule VerificationSchedule { get; set; } = null!;
}