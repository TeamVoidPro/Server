...
namespace Server.Migrations
{
    ...
    [Migration("20230727105407_SeedEmployeeTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.AwaitedParkingPlaces", b =>
                {
                    b.Property<string>("AwaitedParkingPlacesId")
                    ...
                    b.Property<string>("ConfirmationReport")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasKey("AwaitedParkingPlacesId");

                    b.HasIndex("OwnerId");

                    b.HasIndex("ParkingPlaceVerifierId");

                    b.ToTable("AwaitedParkingPlaces");
                });
            ...
            modelBuilder.Entity("Server.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmployeeId = "EMP001",
                            AccountCreatedAt = new DateTime(2023, 7, 27, 10, 54, 6, 380, DateTimeKind.Utc).AddTicks(4296),
                            ...
                            LastName = "Supun",
                            Nic = "199914212942",
                            Password = "$2a$12$LqjfE1qq6njpKzjVdXrvguNksi14BSkgKnsjMTX6XhdjivtFypQg.",
                            ProfilePicture = "https://i.imgur.com/1qk4XKn.jpg",
                            Role = "Operator",
                            Street = "Weragama Road",
                            Token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjEyMyIsIm5iZiI6MTY5MDQ1NTI0NiwiZXhwIjoxNjkxMDYwMDQ2LCJpYXQiOjE2OTA0NTUyNDZ9.DNxjgHEp2hSAFTKT0B84iP6AQfH9zmMyJ03vOjzrlg8"
                        },
                        new
                        {
                            EmployeeId = "EMP002",
                            AccountCreatedAt = new DateTime(2023, 7, 27, 10, 54, 6, 759, DateTimeKind.Utc).AddTicks(6413),
                            AddressLine1 = "108/5 A",
                            City = "Wadduwa",
                            ContactNumber = "0711234567",
                            ...
                            LastName = "Arunodi",
                            Nic = "199914212942",
                            Password = "$2a$12$6j7l1IMLhWrXv9jEbS2qdOfo/f8GlRaFVdzIT056KgBDOrCVz2fiu",
                            ProfilePicture = "https://i.imgur.com/1qk4XKn.jpg",
                            Role = "Verifier",
                            Street = "Weragama Road",
                            Token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjEyMyIsIm5iZiI6MTY5MDQ1NTI0NiwiZXhwIjoxNjkxMDYwMDQ2LCJpYXQiOjE2OTA0NTUyNDZ9.DNxjgHEp2hSAFTKT0B84iP6AQfH9zmMyJ03vOjzrlg8"
                        ...
                        {
                            EmployeeId = "EMP003",
                            AccountCreatedAt = new DateTime(2023, 7, 27, 10, 54, 7, 147, DateTimeKind.Utc).AddTicks(5755),
                            AddressLine1 = "108/5 A",
                            City = "Wadduwa",
                            ContactNumber = "0711234567",
                            ...
                            LastName = "Pramodi",
                            Nic = "199914212942",
                            Password = "$2a$12$fW5lrjcKEoFLrUJa274neuTN2ZiklIIKuFe6Nv8v9idNnCwiXoSeK",
                            ProfilePicture = "https://i.imgur.com/1qk4XKn.jpg",
                            Role = "Administrator",
                            Street = "Weragama Road",
                            Token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IjEyMyIsIm5iZiI6MTY5MDQ1NTI0NywiZXhwIjoxNjkxMDYwMDQ3LCJpYXQiOjE2OTA0NTUyNDd9.pO-jDS5orHkOrHMsSX6CRs0U8DiRhCo60ZlDGbjRvnU"
                        });
                });
